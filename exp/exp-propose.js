...
if (!TEST) propose_timeline.push(consent);
...
var instructions_propose = {
    ...
    pages: ["<p>Please pay attention and carefully read the following instructions.</p><p>In this HIT, you are going to play a game. " +
	    ...
	    "<br><p>One more thing about this game: in each round of the game, you will play with one of three partners: Player A, Player B, and Player C. " +
...
var propose_trial = {
    timeline: [{type: 'html-slider-response',
		stimulus: function () {
			...
			"How much would you like to offer Player " +
		...
		pages: function () {
		    ...
		    return [avatar() + "<p>You have offered Player " + d.player + " $" +
			    d.offer.toFixed(2) + " out of $" + stakes.toFixed(2) +".</p>" +
			    "<p>Player " + d.player + " has " + d.response + "ed your offer.<p>" +
...
var trials_mcmc_propose = {
	...
	stimulus: function () {
	    return avatar() + "<p>You have made an offer to Player " +
...
propose_timeline.push(trials_mcmc_accept)
